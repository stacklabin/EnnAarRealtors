...
export default function ResidentialProjects() {
    return (
        <div className="mainContent bg-gray-900">
           <AllTrendingProjectsSection heading="Residential Projects" type="residential"/>
        </div>
    );
}
...
// export default function ResidentialProjects({ heading, type }) {
//   const [trendingPropertyList, setTrendingPropertyList] = useState([]);
//   const [loading, setLoading] = useState(true);
//   useEffect(async () => {
//     await axios
//       .get("/api/featured-property")
//       .then((res) => {
...
//         {heading}
//       </h2>
//       <div className="cardContainers flex justify-center flex-wrap pt-10">
//         {!loading ? (
...
//             <div className="card rounded-xl overflow-hidden w-full md:w-5/12 flex justify-center">
