    ...
    <>
                  ...
                  <Slide {...options}>
                    {result.imagesArray.map((item) => {
                      return (
                        <div
                          key={item}
                          className='each-slide background text-white h-auto h-min-hight'
                        >
                          <Image
                            className='background-image2 lighter'
      ...
      <div className='bc-gry relative' id='highlights'>
        ...
        <div className='col-50 lfloat container2 containerpad bbox'>
          ...
          <div className='flex justify-between flex-wrap pb-4'>
            {result.sp ? (
              <div className='w-6/12 my-2'>
                <span className='text-indigo-700 text-4xl mr-4'>
                  <FaSwimmer />
                </span>
                <span>Swimming Pool</span>
              </div>
      ...
      {result && result.actualImagesSection != false ? (
        <div id='construction-update' className='container-full'>
          <h4 className='calign blue upper mb-6'>
            {result && result.type == 'residential'
              ? 'Actual Images of the Township'
              : 'Future Prospect'}
          </h4>
            ...
            {result && result.actiualImagesArray ? (
              <>
                {result.actiualImagesArray.map((item) => {
                  return (
                    <a href={item} data-fancybox='gallery' key={item}>
                      <Image
