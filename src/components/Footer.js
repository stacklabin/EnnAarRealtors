  ...
  return (
    <>
      ...
      <footer className='footer-1 py-8 sm:py-12 bg-black text-gray-300'>
        <div
          className='p-4 fixed bottom-27 text-white bg-blue-500 hover:bg-blue-800 right-5 text-xl flex justify-center items-center shadow-xl'
          style={{
            width: '50px',
            height: '50px',
            borderRadius: '50%',
        ...
        <div
          className='p-4 fixed bottom-12 text-white bg-green-500 hover:bg-green-800 right-5 text-xl flex justify-center items-center shadow-xl'
          style={{
            width: '50px',
            height: '50px',
            borderRadius: '50%',
        ...
        >
          <a
            href='https://api.whatsapp.com/send/?phone=%2B919815654145&text&app_absent=0&lang=eng'
            target='_blank'
          >
        ...
        <div className='container  mx-auto px-4'>
          <div className=' flex flex-wrap justify-center'>
            <div className='w-full  md:w-5/12 lg:w-2/12 m-2 p-4  '>
              ...
              <p className='small'>
                ENN AAR Group have earned the badge as the prominent realtor in
                New Chandigarh, providing tailored real estate solutions for
                your dream home or the right office environment for your
                business.
              </p>
              <img
                width='100px'
              ...
              <ul className='list-none footer-links'>
                <li className='mb-2'>
                  ...
                  >
                    ...
                    &nbsp;# 304-A, 3rd Floor, Omaxe India Trade Tower, New
                    Chandigarh
                  </a>
                </li>
                <li className='mb-2'>
            ...
            <div className='w-full text-center'>
              ...
              <p className='small'>
                In the Site, We provides users with access to information
                primarily about Real Estate products and services.. By making
                use of this site, and furnishing your personal / contact
                details, you hereby agree that you are interested in availing
                and purchasing the Service(s) that you have selected. You hereby
                agree that We may contact you either electronically or through
                phone/SMS and may use any 3rd party platform (service provider)
                to contact you, to understand your interest in the selected
                products and Service(s) and to fulfill your demand. You also
                agree that We reserves the right to make your details available
                to its affiliates and partners and you may be contacted by the
                affiliates and partners for information and for sales through
                email, telephone and/or sms. You agree to receive promotional
                materials and/or special offers from us through email or sms.
              </p>
            </div>
          </div>
        </div>
